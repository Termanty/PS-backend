...
const id_questionnaire_1 = "6a3734d0-4499-4dd7-aa06-94a1f8c6f21e";
const id_questionnaire_2 = "b1e5ff6a-6337-4616-b8e0-a9a6e388c6f6";
const id_questionnaire_3 = "b0ba43d1-bbf2-477d-8053-a7f4eff7444a";
...
exports.seed = async function (knex) {
  ...
  await knex("responses").insert([
    {
      questionnaire_id: id_questionnaire_1,
      score: 9,
    ...
    {
      questionnaire_id: id_questionnaire_2,
      score: 6,
      comment: "Soo bad",
    },
    {
    ...
    {
      questionnaire_id: id_questionnaire_3,
      score: 10,
